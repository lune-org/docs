...
the [@lune/luau](/api-reference/luau) library can be used for rudimentary sandboxing. It should be noted
that this **does not** guarantee security, and if necessary, you should be running Lune using a containerized
